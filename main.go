...
func init() {
	...
	cmd.Flags().StringP("proxy-ca-secret", "P", "ca-vpn", "Name of the secret that contains the CA certificate use for the proxy server certificate.")
	cmd.Flags().StringP("proxy-client-secret", "P", "http-proxy", "Name of the secret that contains the client certificate needed for connecting to the proxy.")
